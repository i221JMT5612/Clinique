...
<body>
    ...
    <div class="container py-5">
        ...
        <nav>
            <ul>
                <li><a href="create_consultation.php" class="btn btn-primary">Ajouter une consultation</a></li>
            </ul>
        </nav>
                ...
                <tbody>
                    <?php foreach ($consultations as $consultation): ?>
                        <tr>
                            ...
                            <td>
                                <a href="update_consultation.php?id=<?php echo $consultation['id']; ?>"class="btn btn-warning btn-sm">Modifier</a>
                                <a href="delete_consultation.php?id=<?php echo $consultation['id']; ?>" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cette consultation ?');" class="btn btn-danger btn-sm">Supprimer</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
