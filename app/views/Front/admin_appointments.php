...
<body>
    ...
    <div class="container mt-5">
        ...
        <nav>
            <ul>
                <li><a href="create_appointment.php?action=create" class="btn btn-primary">Ajouter un Rendez-vous</a></li>
            </ul>
        </nav>
                ...
                <?php if (!empty($appointments)): ?>
                    <?php foreach ($appointments as $appointment): ?>
                        <tr>
                            ...
                            <td>
                                <a href="update_appointment.php?id=<?php echo $appointment['id']; ?>" class="btn btn-warning btn-sm">Modifier</a>
                                <a href="delete_appointment.php?id=<?php echo $appointment['id']; ?>" onclick="return confirm('Êtes-vous sûr de vouloir supprimer ce rendez-vous ?');" class="btn btn-danger btn-sm">Supprimer</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                <?php else: ?>
