...
<body>
    ...
    <div class="container mt-5">
        <h2 class="my-4">Liste des Dossiers Médicaux</h2>
        <nav>
            <ul class="list-unstyled">
                <li><a href="create_medical_record.php?action=create" class="btn btn-primary mb-3">Ajouter un dossier médical</a></li>
            </ul>
        </nav>
                ...
                <?php if (!empty($records)): ?>
                    <?php foreach ($records as $record): ?>
                        <tr>
                            ...
                            <td>
                                <a href="update_record.php?id=<?php echo $record['id']; ?>" class="btn btn-warning">Modifier</a>
                                <a href="delete_record.php?id=<?php echo $record['id']; ?>" class="btn btn-danger" onclick="return confirm('Êtes-vous sûr de vouloir supprimer ce dossier médical ?');">Supprimer</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                <?php else: ?>
