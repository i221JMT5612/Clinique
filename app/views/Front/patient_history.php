...
$consultationController = new ConsultationController($db);  // Passez $db ici
$patient_id = 1; // Exemple d'ID patient, devrait être dynamiquement défini en fonction du patient connecté

$consultations = $consultationController->getPastConsultationsByPatientId($patient_id);
?>
...
<head>
    ...
    <title>Patient - Historique des Consultations</title>
    <!-- Favicon -->
...
<body>
    ...
    <div class="container mt-5">
        <h1 class="my-4">Historique des Consultations</h1>
        
        <!-- Afficher la liste des consultations passées -->
        <?php
        // Vérifie si des consultations ont été récupérées
        if (count($consultations) > 0) {
            ...
            foreach ($consultations as $consultation) {
                echo '<tr>
                        ...
                        <td>' . htmlspecialchars($consultation['notes']) . '</td>
                    </tr>';
            }
            echo '</tbody></table>';
        } else {
            echo '<p>Vous n\'avez aucune consultation passée.</p>';
        }
        ?>
    </div>
    <!-- Main Content End -->
