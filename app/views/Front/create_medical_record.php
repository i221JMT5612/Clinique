...
require_once 'C:\xampp\htdocs\Clinique\app\controllers\DoctorController.php';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!is_numeric($patient_id) || !is_numeric($doctor_id)) {
        ...
        // Appeler la méthode createRecord avec les bons arguments
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!is_numeric($patient_id) || !is_numeric($doctor_id)) {
        $message = "Les ID doivent être numériques.";
    } else {
        $patients = $PatientController->getPatientById($patient_id);
        $doctors = $DoctorController->getDoctorById($doctor_id);
...
<body>
    ...
    <div class="container mt-5">
        <h2 class="my-4">Créer un Dossier Médical</h2>
        ...
        <form action="create_medical_record.php" method="POST">
            ...
            <input type="submit" value="Créer le Dossier Médical" class="btn btn-primary">
        </form>
