...
<body>
    ...
    <div class="container mt-5">
        ...
        <nav>
            <ul>
                <li><a href="create_user.php?action=create" class="btn btn-primary">Ajouter un utilisateur</a></li>
            </ul>
        </nav>
            ...
            <tbody>
                <?php foreach($users as $user): ?>
                    <tr>
                        ...
                        <td>
                            <a href="update_user.php?id=<?php echo htmlspecialchars($user['id']); ?>" class="btn btn-warning">Modifier</a>
                            <a href="delete_user.php?id=<?php echo htmlspecialchars($user['id']); ?>" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cet utilisateur ?');" class="btn btn-danger">Supprimer</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
